...
filename = 'CameraCalibrationVideo.avi'
#Directory Information
checkerboard_directory = 'CheckerboardPhotos_RealTesting/'
...
def ImageCollect(filename, n_boards, checkerboard_directory):
    ...
    if status == True:
        ...
        while current_frame < total_frames:
            ...
            if k == 32:
                collected_images += 1
                cv2.imwrite(f'{checkerboard_directory}Calibration_Image' + str(collected_images) + '.png', image)
...
def ImageProcessing(n_boards, board_w, board_h, board_dim, checkerboard_directory):
    ...
    for i in range(1, n_boards+1):
        ...
        #Loading images
        print ('Loading... Calibration Image... ' + IMAGES[i-1][-12:-4] + '.png' )
    ...
    for i in range(1, n_boards+1):
        ...
        cv2.imwrite(f'{checkerboard_directory}undistorted_{IMAGES[i-1][-12:-4]}.png', dst)
...
ImageCollect(filename, n_boards, checkerboard_directory)
...
ImageProcessing(n_boards, board_w, board_h, board_dim, checkerboard_directory)
