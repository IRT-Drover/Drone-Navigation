...
def p_to_c_testing(PATH, pictureData):
    #Camera Specs
    ...
    lat_0 = 40.61814910646263 #latitude
    long_0 = -74.56709462796948 #longitude
    
    drone = LatLon(lat_0, long_0, datum=Datums.NAD83) # default datum is WGS-84

    rover_path = []
    
    print("---")
    
    # # TESTING DISTANCE MEASUREMENT ACCURACY
